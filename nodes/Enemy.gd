...
## Current armor points; absorbs incoming damage before HP is reduced. Persists between turns.
@export var armor: int = 0

func _ready() -> void:
	hp = max_hp

## Reduce hp by amount, applying armor absorption first, then damage_multiplier.
